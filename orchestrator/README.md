...
If the failure is sufficiently catastrophic, make a new manifest detailing, for each row, the last point at which you feel comfortable with the results. Perform converesion using --manifest then continue using --status.